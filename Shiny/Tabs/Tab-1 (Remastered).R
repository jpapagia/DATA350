#
# Alexandra Julka, Yianni Papagiannopoulos
#
...
Listening on http://127.0.0.1:4619
> library(shiny)
> library(factoextra)
> library(FactoMineR)
> library(ggplot2)
...
+                 plotOutput("pcaPlot"),
+                 br(),
+                 tags$strong("PCA Loadings (weights/contributions of each Variable for each principal component):"),
+                 tableOutput("loadingsTablePCA"),
+                 br(),
+                 tags$strong("PCA Summary (variance explained):"),
+                 verbatimTextOutput("pcaSummary"),
